...
const Hero = () => {
  return (
    <main
      className="section dark:gradient-background-dark gradient-background-light flex h-max w-full flex-col rounded-b-[86px] px-1.5 text-background  dark:text-text sm:h-[84lvh] sm:px-0 lg:h-[100vh]"
      id="home"
    >
